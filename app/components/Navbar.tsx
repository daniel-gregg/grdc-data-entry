        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        ...
                        <li>
                            <Link to="/login" className="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-[#1d6146] md:hover:bg-transparent md:hover:text-[#1d6146] md:dark:hover:text-[#1d6146] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Login</Link>
                        </li>
                        <link rel="prefetch" />
                        </ul>
                    </div>
